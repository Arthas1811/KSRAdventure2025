...
public class VideoPlayerLoaderConstruction : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (!string.IsNullOrEmpty(VideoPlayerLoaderConstruction.VideoPath) && VideoPlayer != null)
        {
            VideoPlayer.playOnAwake = false;
            VideoPlayer.waitForFirstFrame = true;
            VideoPlayer.url = VideoPlayerLoaderConstruction.VideoPath;
            VideoPlayer.Prepare();
        }
